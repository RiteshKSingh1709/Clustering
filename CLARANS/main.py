from util import clarans,create_cluster_image
import sys
...
def main():
	...
	print "\n\n\t\t---:For Diseased:---"
	print "\t\t--------------------\n\n"
	cls,best_node=clarans(data, 3, 30, c,k)
	...
	im_diseased.show()
	im_normal.show() 
	im_diseased.save("CLARANS_DISEASED.png")
	im_normal.save("CLARANS_NORMAL.png") 
